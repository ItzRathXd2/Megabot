...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/LunaxSupport'),
                    ...
                    [ 
                        ...
                        [
                            ...
                            InlineKeyboardButton(
                                ...
                                url="https://github.com/Ashmit-OP/Lunabot",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "support_chat_link_btn"),
                                url='https://t.me/LunaxSupport',
                            ),
                            InlineKeyboardButton(
                                text="Help",
...
def donate(update: Update, _: CallbackContext):
    ...
    update.effective_message.reply_text("Contact in @ASHMIT999!  >_<")
